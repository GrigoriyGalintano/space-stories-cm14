...
ent-RMCCryoRecoveryConsole = консоль восстановления из гиперсна
    .desc = Консоль поставок, используемая для восстановления снаряжения морпехов, ушедших в долгосрочный гиперсон.
    .suffix = Поставки
