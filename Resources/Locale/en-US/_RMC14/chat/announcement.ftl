...
rmc-announcement-delta = [color=#CECECE][font size=16][bold]EMERGENCY SCUTTLE AUTHORIZATION[/bold][/font][/color]\n[color=red][font size=16][bold]DANGER, ARES has authorized emergency scuttle by Engineering reactor overload. Qualified engineers may configure active fusion reactors with a multitool.[/bold][/font][/color]
